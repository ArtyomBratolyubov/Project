...
window.Modernizr = (function( window, document, undefined ) {
    ...
    injectElementWithStyles = function( rule, callback, nodes, testnames ) {
      ...
      if ( !body ) {
          //avoid crashing IE8, if background File is used
    ...
    tests['multiplebgs'] = function() {
        // Setting multiple Files AND a color on the background shorthand property
    ...
    tests['borderFile'] = function() {
        return testPropsAll('borderFile');
    };
    ...
    tests['cssgradients'] = function() {
         ...
         * dev.w3.org/csswg/css3-Files/#gradients-
         */

        var str1 = 'background-File:',
        ...
        setCss(
             ...
             // standard syntax             // trailing 'background-File:'
              prefixes.join(str3 + str1)).slice(0, -str1.length)
        );

        return contains(mStyle.backgroundFile, 'gradient');
    };
